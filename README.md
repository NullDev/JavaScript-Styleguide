...
This Styleguide is based on [AirBnB's JavaScript Styleguide](https://github.com/airbnb/javascript) and uses the same [License](https://github.com/NullDevCo/JavaScript-Styleguide/blob/master/LICENSE). 
